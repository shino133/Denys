<div class="footer" style="height:16rem">
  <p style="  font-size: x-large;margin-top:0;"><?= APP_NAME ?? "Name" ?></p>
  <ul class="footer-icons">
    <li class="foot-item">
      <a href="https://github.com/shino133/Denys" class="foot-link"><i class="fa-brands fa-github"></i></a>
    </li>
    <li class="foot-item">
      <a href="#" class="foot-link"><i class="fab fa-twitter"></i></a>
    </li>
    <li class="foot-item">
      <a href="#" class="foot-link"><i
