    ...
    <div class="col-md-12 message-right-side">
      <nav id="navbar-main" class="navbar navbar-expand-lg shadow-sm sticky-top">
        <ul class="navbar-nav mr-5" id="main_menu">
          <a class="navbar-brand nav-item mr-lg-5" href="index.html"><img src="assets/images/logo-64x64.png" width="40"
              height="40" class="mr-3" alt="Logo" /></a>

          <li class="dropdown nav-item nav-quick-links" data-toggle="tooltip" data-placement="bottom"
            title="Quick Links">
            <a href="#" class="nav-link nav-links nav-icon" role="button" data-toggle="dropdown" aria-haspopup="true"
              aria-expanded="false"><i class="bx bx-align-middle"></i></a>
            <div class="dropdown-menu nav-drop">
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  <a href="find-friends.html" class="sidebar-item"><i class="bx bxs-user-detail text-primary"></i> Find
                    Friends</a>
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                  <a href="teams.html" class="sidebar-item"><i class="bx bxl-slack-old text-primary"></i> Argon For
                    Teams</a>
                  <span class="badge badge-primary badge-pill"><i class="bx bx-chevron-right"></i></span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
            ...
            <ul class="dropdown-menu notify-drop dropdown-menu-right nav-drop">
              ...
              <div class="drop-content">
                ...
                <li>
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-9 pd-l0">
                    <a href="#" class="notification-user">Ruth D. Greene
                      <span class="badge badge-pill badge-primary ml-1">1</span></a>
                    <a href="#" class="notify-right-icon">
                      <i class="bx bx-radio-circle-marked"></i>
                    </a>
          ...
          <li class="nav-item dropdown">
            <a href="#" class="nav-link nav-links drop-w-tooltip" data-toggle="dropdown" data-placement="bottom"
              data-title="Notifications" role="button" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="drop-content">
                ...
                <li>
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-9 pd-l0">
                    ...
                    <span class="notification-type">posted in </span><a href="#"
          ...
          <li class="nav-item nav-icon">
            <a href="settings.html" data-toggle="tooltip" data-placement="bottom" data-title="Settings"
              class="nav-link"><img src="assets/images/icons/navbar/settings.png" class="nav-settings"
                alt="navbar icon" /></a>
          </li>
        </ul>
      </nav>
                ...
                <ul class="conversations">
                  ...
                  <li class="contact setting-active">
                    <a href="settings.html" class="wrap d-flex align-items-center">
                      <img src="assets/images/icons/settings/account.png" class="settings-icon"
                  ...
                  <li class="contact">
                    <a href="settings-contact.html" class="wrap d-flex align-items-center">
                      <img src="assets/images/icons/settings/contact.png" class="settings-icon"
                        alt="Settings left sidebar" />
                      <div class="meta">
                        <p>Contact Info</p>
                      </div>
                  ...
                  <li class="contact">
                    <a href="#" class="wrap d-flex align-items-center">
                      <img src="assets/images/icons/settings/privacy.png" class="settings-icon"
                        alt="Settings left sidebar" />
                      <div class="meta">
                        <p>Privacy</p>
                      </div>
                  ...
                  <li class="contact">
                    <a href="#" class="wrap d-flex align-items-center">
                      <img src="assets/images/icons/settings/security-question.png" class="settings-icon"
                        alt="Settings left sidebar" />
                      <div class="meta">
                  ...
                  <li class="contact">
                    <a href="settings-fingerprint.html" class="wrap d-flex align-items-center">
                      <div class="meta"></div>
                      <p>
                        <img src="assets/images/icons/settings/fingerprint.png" class="settings-icon"
                          alt="Settings left sidebar" />
                        Fingerprint Lock
                      </p>
                    </a>
                  ...
                  <li class="contact">
                    <a href="settings-location.html" class="wrap d-flex align-items-center">
                      <div class="meta"></div>
                      <p>
                        <img src="assets/images/icons/settings/location.png" class="settings-icon"
                          alt="Settings left sidebar" />
                        Location
                      </p>
                    </a>
                  ...
                  <li class="contact">
                    <a href="settings-billing-method.html" class="wrap d-flex align-items-center">
                      <div class="meta"></div>
                      <p>
                        <img src="assets/images/icons/settings/wallet.png" class="settings-icon"
                          alt="Settings left sidebar" />
                        Billing Method
                      </p>
                    </a>
                  ...
                  <li class="contact">
                    <a href="#" class="wrap d-flex align-items-center">
                      <div class="meta"></div>
                      <p>
                        <img src="assets/images/icons/settings/credit-card.png" class="settings-icon"
                          alt="Settings left sidebar" />
                        Automatic Payments
                      </p>
                    </a>
                  ...
                  <div class="col-md-12">
                    <div class="form-row mb-3 align-items-center">
                      <div class="col">
                        ...
                        <input type="email" class="form-control" id="settingsUsername" aria-describedby="usernameHelp"
                          value="arthur_minasyan_96" placeholder="Username" />
                        <small id="usernameHelp" class="form-text text-muted">Your public username is the same as your
                          timeline
                          address.</small>
                      </div>
                      <div class="col check-username">
                        <span><i class="bx bx-check success"></i> Username is
                          available</span>
                      </div>
                    </div>
                  </div>
