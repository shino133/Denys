            ...
            <div class="w-100 justify-content-md-center">
              ...
              <ul class="navbar-nav mr-5 flex-row" id="main_menu">
                ...
                <li class="nav-item s-nav dropdown d-mobile">
                  ...
                  <div
                    class="dropdown-menu dropdown-menu-right nav-dropdown-menu"
                  >
                    <a
                      href="#"
                      class="dropdown-item"
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-10">
                          ...
                          <small id="createGroup" class="form-text text-muted"
                            >Find people with shared interests</small
                          >
                        </div>
                      </div>
                    </a>
                ...
                <li class="nav-item s-nav dropdown message-drop-li">
                  ...
                  <ul
                    class="dropdown-menu notify-drop dropdown-menu-right nav-drop shadow-sm"
                  >
                    ...
                    <div class="drop-content">
                      <li>
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-10">
                          ...
                          <span class="notification-type"
                            >replied to your comment on a post in </span
                          ><a href="#" class="notification-for">PHP</a>
                          <a href="#" class="notify-right-icon">
                            <i class="bx bx-radio-circle-marked"></i>
                          </a>
                          <p class="time">
                      ...
                      <li>
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-10">
                          ...
                          <span class="notification-type">posted in </span
                          ><a href="#" class="notification-for">Themeforest</a>
                          <a href="#" class="notify-right-icon">
                            <i class="bx bx-radio-circle-marked"></i>
                          </a>
                          <p class="time">
                ...
                <li class="nav-item s-nav dropdown d-mobile">
                  <a
                    href="#"
                    class="nav-link nav-links nav-icon drop-w-tooltip"
                    data-toggle="dropdown"
                    data-placement="bottom"
                    data-title="Pages"
                    role="button"
                  ...
                  <div class="dropdown-menu dropdown-menu-right nav-drop">
                    <a class="dropdown-item" href="newsfeed-2.html"
                      >Newsfeed 2</a
                    >
              ...
              <div id="message-frame">
                <div class="message-sidepanel">
                    ...
                    <div class="wrap">
                      ...
                      <div id="status-options">
                        <ul id="set-online-status">
                          <li id="status-online" class="messenger-user-active">
                      ...
                      <div id="expanded">
                        <ul class="list-group list-group-flush">
                          <li class="list-group-item">
                            <a href="javascript:void(0)" class="text-dark fs-9"
                              ><i class="bx bx-search text-primary mr-3"></i>
                              Search in Conversation</a
                            >
                          </li>
                          <li class="list-group-item">
                            <a href="javascript:void(0)" class="text-dark fs-9"
                              ><i class="bx bx-pencil text-primary mr-3"></i>
                              Edit Nicknames</a
                            >
                          </li>
                          <li class="list-group-item">
                            <a href="javascript:void(0)" class="text-dark fs-9"
                              ><i
                                class="bx bxs-color-fill text-primary mr-3"
                              ></i>
                              Change Color</a
                            >
                          </li>
                          <li class="list-group-item">
                            <a href="javascript:void(0)" class="text-dark fs-9"
                              ><i class="bx bx-bell text-primary mr-3"></i>
                              Notifications</a
                            >
                          </li>
                        </ul>
                  ...
                  <div class="message-search position-relative d-flex">
                    ...
                    <button
                      type="button"
                      class="btn btn-create-conversation"
                      data-toggle="modal"
                      ...
                      <li class="contact messenger-user-active">
                        <div class="wrap">
                          ...
                          <div class="meta">
                            ...
                            <p class="preview">
                              This party is going to have a DJ, food, and
                              drinks.
                            </p>
                          </div>
                        </div>
                      ...
                      <li class="contact">
                        <div class="wrap">
                          ...
                          <div class="meta">
                            ...
                            <p class="preview">
                              <span>You:</span> Yeah, I will be there.
                            </p>
                          </div>
                        </div>
                      </li>
                      ...
                      <li class="contact">
                        <div class="wrap">
                          ...
                          <div class="meta">
                            ...
                            <p class="preview">
                              <span>You:</span> Sure, what can I help you with?
                            </p>
                          </div>
                        </div>
                      </li>
                      ...
                      <li class="contact">
                        <div class="wrap">
                          ...
                          <div class="meta">
                            ...
                            <p class="preview">
                              <span>You:</span> Certainly. This will take only a
                              few seconds.
                            </p>
                          </div>
                        </div>
                ...
                <div class="content">
                  <div class="row">
                    <div class="col-md-12 messenger-top-section">
                      <div
                        class="contact-profile d-flex align-items-center justify-content-between"
                      >
                        <div class="messenger-top-luser df-aic">
                          ...
                          />
                          <a href="#" class="message-profile-name"
                            >Susan P. Jarvis</a
                          >
                        </div>
                        <div class="social-media messenger-top-ricon df-aic">
                          <img
                            src="assets/images/icons/messenger/phone.png"
                            data-toggle="modal"
                            data-target="#callModal"
                            class="msg-top-more-info"
                            alt="Messenger icons"
                          />
                          <img
                            src="assets/images/icons/messenger/videocam.png"
                            class="msg-top-more-info"
                            alt="Messenger icons"
                          />
                          <img
                            src="assets/images/icons/messenger/info.png"
                            class="msg-top-more-info"
                            alt="Messenger icons"
                          />
                          <span class="dropdown">
                            ...
                            <div
                              class="dropdown-menu dropdown-menu-right fs-9"
                      ...
                      <div class="messages">
                        <ul class="messages-content">
                          ...
                          <li class="message-receive">
                            ...
                            />
                            <p>
                              It starts at 8:00 pm, and I really think you
                              should go.
                            </p>
                          </li>
                          <li class="message-reply">
                      ...
                      <div class="message-input">
                        <div class="wrap">
                          <form class="d-inline form-inline">
                            <div
                              class="d-flex align-items-center justify-content-between messenger-icons"
                            >
                              <button type="button" class="btn search-button">
                                <img
                                  src="assets/images/icons/messenger/m-camera.png"
                                  alt="Messenger icons"
                                />
                              </button>
                              <button type="button" class="btn search-button">
                                <img
                                  src="assets/images/icons/messenger/m-photo.png"
                                  alt="Messenger icons"
                                />
                              </button>
                              <button type="button" class="btn search-button">
                                <img
                                  src="assets/images/icons/messenger/m-gamepad.png"
                                  alt="Messenger icons"
                                />
                              </button>
                              <button type="button" class="btn search-button">
                                <img
                                  src="assets/images/icons/messenger/m-microphone.png"
                                  alt="Messenger icons"
                                />
                              </button>
                              <div class="input-group messenger-input">
                                ...
                                <div class="input-group-append">
                                  ...
                                  >
                                    <img
                                      src="assets/images/icons/messenger/m-smile.png"
                                      alt="Messenger icons"
                                    />
                                  </button>
                                </div>
                              ...
                              >
                                <img
                                  src="assets/images/icons/messenger/m-send.png"
                                  alt="Messenger icons"
                                />
                              </button>
                            </div>
