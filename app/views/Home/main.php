      ...
      <div class="row newsfeed-right-side-content mt-3">
        ...
        <div class="col-md-6 second-section" id="page-content-wrapper">
          ...
          <div class="posts-section mb-5">
            <div class="py-3">
              <div class="post border-bottom p-3 bg-white w-shadow">
                <div class="media text-muted pt-3">
                  <img src="/public/img/users/user-1.jpg" alt="Online user" class="mr-3 post-user-image" />
                                      ...
                                      <div class="col-md-12">
                                        <div class="input-group">
                                          ...
                                          <div class="input-group-btn">
                                            ...
                                            <button type="button" class="btn comment-form-btn comment-form-btn"
            ...
            <div class="post border-bottom p-3 bg-white w-shadow">
              <div class="media text-muted pt-3">
                <img src="/public/img/users/user-2.jpg" alt="Online user" class="mr-3 post-user-image" />
                <div class="media-body pb-3 mb-0 small lh-125">
                  <div class="d-flex justify-content-between align-items-center w-100">
              ...
              <div class="d-block mt-3">
                <video id="my_video_1" class="video-js vjs-default-skin post-content" width="640px" height="400px"
            ...
            <div class="post border-bottom p-3 bg-white w-shadow">
              <div class="media text-muted pt-3">
                <img src="/public/img/users/user-4.jpg" alt="Online user" class="mr-3 post-user-image" />
                <div class="media-body pb-3 mb-0 small lh-125">
                  <div class="d-flex justify-content-between align-items-center w-100">
