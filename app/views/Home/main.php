        ...
        <div class="row newsfeed-size">
            <div class="col-md-12 newsfeed-right-side">
                <nav
                    ...
                    <div class="w-100 justify-content-md-center">
                        ...
                        <ul class="navbar-nav mr-5 flex-row" id="main_menu">
                            ...
                            <form
                                class="w-30 mx-2 my-auto d-inline form-inline mr-5 dropdown search-form">
                                <div
                                    class="input-group"
                                ...
                                <ul
                                    class="dropdown-menu notify-drop nav-drop shadow-sm"
                                    ...
                                    <div class="drop-content">
                                        <li>
                                            ...
                                            <div class="col-md-10 col-sm-10 col-xs-10">
                                                ...
                                                <span class="notification-type">replied to your comment on a post in </span><a href="#" class="notification-for">PHP</a>
                                                <a href="#" class="notify-right-icon">
                                                    <i class="bx bx-radio-circle-marked"></i>
                                                </a>
                                                <p class="time">
                                        ...
                                        <li>
                                            ...
                                            <div class="col-md-10 col-sm-10 col-xs-10">
                                                ...
                                                <span class="notification-type">posted in </span><a href="#" class="notification-for">Argon Social Design System</a>
                                                <a href="#" class="notify-right-icon">
                                                    <i class="bx bx-radio-circle-marked"></i>
                                                </a>
                                                <p class="time">
                ...
                <div class="row newsfeed-right-side-content mt-3">
                    <div
                        class="col-md-3 newsfeed-left-side sticky-top shadow-sm"
                        id="sidebar-wrapper">
                        <div class="card newsfeed-user-card h-100">
                            <ul class="list-group list-group-flush newsfeed-left-sidebar">
                                ...
                                <li
                                    class="list-group-item d-flex justify-content-between align-items-center newsLink">
                                    <a
                    ...
                    <div class="col-md-6 second-section" id="page-content-wrapper">
                        ...
                        <div class="posts-section mb-5">
                            <div class="post border-bottom p-3 bg-white w-shadow">
                                ...
                                <div class="mt-3">
                                    <p>
                                        ...
                                        voluptatum, incidunt saepe minus maiores ea atque sequi
                                        illo veniam sint quaerat corporis totam et. Culpa?
                                    </p>
                                </div>
                                    ...
                                    <div class="argon-reaction">
                                        <span class="like-btn">
                                            ...
                                            <ul class="reactions-box dropdown-shadow">
                                                ...
                                                <li
                                                    class="reaction reaction-wow"
                                                    data-reaction="Wow"></li>
                                                <li
                                                    class="reaction reaction-sad"
                            ...
                            <div class="d-flex justify-content-center my-5 load-post">
                                <button
                                    type="button"
                                    class="btn btn-quick-link join-group-btn border shadow"
                                    data-toggle="tooltip"
                                    data-placement="top"
                                    data-title="Load More Post">
                                    <i class="bx bx-dots-horizontal-rounded"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 third-section">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                <div
                                    class="weather-card-header d-flex justify-content-between align-items-center">
